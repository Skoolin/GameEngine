...
public class OBJLoader {
	...
	public static RawModel loadObjModel(String fileName) {
		FileReader fr = null;
		try {
			fr = new FileReader(new File(Const.RESSOURCES_FOLDER + fileName + ".obj"));
		} catch (FileNotFoundException e) {
			System.err.println("Cound't load file!");
			e.printStackTrace();
		}
	...
	private static void processVertex(String[] vertexData, List<Integer> indices, List<Vector2f> textures,
		...
		texturesArray[currentVertexPointer * 2 + 1] = 1 - currentText.y;
