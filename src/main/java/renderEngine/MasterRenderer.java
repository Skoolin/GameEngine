...
public class MasterRenderer {
	...
	private Map<TexturedModel, List<Entity>> staticEntities = new HashMap<TexturedModel, List<Entity>>();
	private Map<AnimatedModel, List<Entity>> animatedEntities = new HashMap<AnimatedModel, List<Entity>>();
	...
	public MasterRenderer() {
		...
		renderer = new StaticRenderer(shader, projectionMatrix);
	...
	public void render(List<Light> lights, Camera camera) {
		...
		renderer.render(staticEntities, lights);
		shader.stop();
		...
		animatedModelRenderer.renderAnim(animatedEntities, lights);
   ...
   protected void createProjectionMatrix(){
	...
	public void processStaticEntity(Entity entity) {
		TexturedModel entityModel = (TexturedModel) entity.getModel();
	...
	public void processAnimatedEntity(Entity entity) {
		AnimatedModel entityModel = (AnimatedModel) entity.getModel();
		List<Entity> batch = animatedEntities.get(entityModel);
		if(batch!= null) {
			batch.add(entity);
		} else {
			List<Entity> newBatch = new ArrayList<Entity>();
